...
const Hero = () => {
  const stats = [
    { label: "Trucks", value: "1M+", icon: Truck },
    { label: "MSME", value: "16K+", icon: Package },
    { label: "Daily Loads", value: "1,200+", icon: MapPin },
    { label: "Pincodes Covered", value: "10k+", icon: Zap },
  ];
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center min-h-[80vh]">
          ...
          <div className="text-white">
            ...
            <p className="text-xl text-gray-200 mb-8 leading-relaxed max-w-lg">
              India's first truck booking marketplace redefining the way goods move at the touch of a button.
            </p>
            
            <div className="flex flex-col sm:flex-row gap-4 mb-12">
              <Button 
                size="lg" 
                className="bg-green-500 text-white hover:bg-green-600 px-8 py-4 text-lg font-semibold rounded-xl shadow-xl hover:shadow-2xl transition-all duration-300"
              ...
              <Button 
                variant="outline" 
                size="lg" 
                className="border-2 border-white/30 bg-white/10 backdrop-blur-sm text-white hover:bg-white hover:text-gray-900 px-8 py-4 text-lg font-semibold rounded-xl transition-all duration-300"
                onClick={() => window.location.href = '/auth'}
              >
                Learn more
              </Button>
            ...
            <div className="space-y-6">
              <div className="relative">
                ...
                <input 
                  ...
                  className="w-full pl-12 pr-4 py-4 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-green-500 focus:border-green-500 text-lg transition-all duration-200"
                />
              </div>
